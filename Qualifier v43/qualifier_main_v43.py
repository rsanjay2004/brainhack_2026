...
def build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Fast progress-first online exploration qualifier mission with YOLO barrel counting")
    ...
    p.add_argument("--output-dir", default="qualifier_output_v43")
