...
This version is based on qualifier_main_v49.py. It keeps the existing YOLO red/yellow
...
SCRIPT TO RUN:
python3 qualifier_right_wall_v50_corner.py --mode count \
...
class QualifierMission:
    ...
    async def drive_right_wall_step(self, pose: Dict[str, float], depth_frame: Optional[np.ndarray]) -> None:
        ...
        target_right = float(getattr(self.args, "right_wall_target_m", 1.10))
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--output-dir", default="qualifier_output_right_wall_v49")
    ...
    p.add_argument("--right-wall-target-m", type=float, default=1.10, help="Desired clearance from the right wall")
